...
## Features included in Trello Board.
 ...
 In the current version, cards can only be moved to adjacent columns, In future versions it will be modified to either of the following ways:
...
4. Persisting data in local storage.
